"""Resolved record-type schemas for document boards and dynamic forms.
...
from app.models.record import RecordAttribute, RecordStageTemplate, RecordTemplate, RecordType
