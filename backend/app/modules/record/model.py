"""Record-owned canonical SQLAlchemy models."""
...
from app.db.mixins import ActiveFlagMixin, CreatedAtMixin, OfficerActorMixin, StatusMixin, TimestampMixin, UUIDPrimaryKeyMixin, VersionMixin
...
# --- Collaboration / operational history owned by Record (moved from legacy app/models/audit.py) ---
