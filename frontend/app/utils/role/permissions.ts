...
export const ROLE_DOCUMENT_TYPES: readonly RoleDocumentTypeDefinition[] = [
  ...
  { value: 'meeting_topic', labelKey: 'docetra.pages.meetingTopic', permissionPrefix: 'records.meeting_topic', actions: WORKFLOW_ACTIONS },
  { value: 'meeting_history', labelKey: 'docetra.pages.meetingHistory', permissionPrefix: 'records.meeting_history', actions: WORKFLOW_ACTIONS },
  ...
  { value: 'purpose', labelKey: 'docetra.pages.purpose', permissionPrefix: 'organizations.purposes', actions: MASTER_DATA_ACTIONS },
  { value: 'sector', labelKey: 'docetra.pages.sector', permissionPrefix: 'organizations.sectors', actions: MASTER_DATA_ACTIONS },
