...
|---|---|---|---|
| Workflow records | **Topic-style 1+3 stage board** (Incoming / Outgoing / Document / Master List Request) | Full document page; tabs merge from selected **record type** | Comments + activity |
